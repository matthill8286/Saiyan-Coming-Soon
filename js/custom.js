$(document).ready(function () {
    ...
    emailjs
      ...
      .then(
        function (response) {
          ...
          message.val("")
          name.val("")
          messageText.html(`<p>Confirmed</p>`)
        },
        function (error) {
          console.log("FAILED...", error)
          messageText.html(`<p>errors</p>`)
        }
      )
  })

  notifyForm.on("click", function () {
    emailjs
      .send("service_rof6zzk", "template_pwwqgb4", {
    ...
    var parseThumbnailElements = function (el) {
      ...
      for (var i = 0; i < numNodes; i++) {
        ...
        if (figureEl.children.length > 1) {
          ...
          item.title =
            "<h4>" +
            figureEl.children[1].innerHTML +
            "</h4><p>" +
            figureEl.children[2].innerHTML +
            "</p>"
        }
  ...
  $("#photoswipe").load(
    "js/plugins/photoswipe/include/photoswipe.html",
    function () {
